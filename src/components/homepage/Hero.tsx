    ...
    return (
        <section className="h-screen flex flex-row justify-between gap-10 md:px-10 xl:pl-20 xl:pr-0" >
            <div className="flex flex-col justify-center xs:content-center w-full">
                <h1 className="hero-fluid-text xs:text-center xs:mx-auto font-josefin py-7 font-bold text-transparent
                bg-clip-text bg-gradient-to-br from-[#777] via-[#000] to-[#777]
                ">The option picker. <br /> Revisited. <br />Made for <span className="bg-clip-text text-transparent bg-gradient-to-br from-[#ff8cc6] via-[#ffffff] to-[#15c4ff] drop-shadow-[0px_0px_2px_rgb(0,0,0)]">you</span><span>.</span>
                </h1>
                ...
                <form className="flex flex-col content-end py-10 w-full">
                    ...
                    <div className="flex xs:flex-col md:flex-row xs:justify-center md:justify-start gap-10">
                        <div className="relative basis-4/6">
                            ...
                            <label htmlFor="marketing-email" className="xs:w-max typing-effect typing-effect--label absolute text-lg translate-x-4 translate-y-1  ">Your email here</label>
                        </div>
                        <input className='xs:w-max xs:mx-auto md:mx-0 basis-2/6 neumButton px-6 py-3' type='submit' value='Get started!' />
                    </div>
                </form>
            </div>
