...
export const Footer = () => {
    return (
        <footer className="footer row-wrap flex flex-col justify-between p-xl mt-10">
            <div className="footer-links flex xs:flex-col md:flex-row  px-10 gap-10 items-center  ">
                <img className=" p-2 xs:ml-0 md:ml-4" src={logo} width='120' alt={"footer logo"} >
                </img>
                <span className=" ">
            ...
            <p className="text-gray-600 py-10 px-10 xs:text-center md:text-left">
