        ...
        <>
            <div className="py-10 bg-[#000000bb] text-4xl transition duration-150 ease-in-out fixed top-0 right-0 bottom-0 left-0 z-50" id="modal">
                <div role="alert" className="container mx-auto w-11/12 md:w-8/10 max-w-lg">
                    <form className="relative py-8 px-5 md:px-10  bg-[#f7d6e0] z-[999] rounded-3xl border border-gray-400" >
                        ...
                        <div className="flex items-center justify-start w-full">
                            <button type="submit" className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 transition duration-150 ease-in-out hover:bg-indigo-600 bg-indigo-700 rounded text-white px-8 py-2 text-sm sugarCloudBtn">Register Now</button>
                            <button onClick={closeSignupModal} type="button" className="focus:outline-none focus:ring-2 focus:ring-offset-2  focus:ring-gray-400 ml-3 bg-gray-100 transition duration-150 text-gray-600 ease-in-out hover:border-gray-400 hover:bg-gray-300 border rounded px-8 py-2 text-sm sugarCloudBtn" >Cancel</button>
                        </div>
